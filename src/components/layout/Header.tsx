    ...
    <header className="h-16 bg-background border-b border-border shadow-nav flex items-center justify-between px-4">
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:flex items-center gap-4">
          <div className="relative">
            ...
            <Input 
              placeholder="Search visitors, guards, clients..." 
      ...
      <div className="flex items-center gap-3">
        ...
        <Button variant="ghost" size="icon" className="relative">
          ...
          <Badge className="absolute -top-1 -right-1 h-5 w-5 rounded-full bg-status-danger text-white text-xs p-0 flex items-center justify-center">
            3
          </Badge>
        </Button>
